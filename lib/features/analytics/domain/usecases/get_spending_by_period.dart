...
class GetSpendingByPeriod {
  GetSpendingByPeriod(this._repository);

  final AnalyticsRepository _repository;

  Future<List<SpendingPoint>> call(
    AnalyticsPeriod period, {
    DateTime? referenceDate,
  }) {
    final ref = referenceDate ?? DateTime.now();
    final (start, end) = _dateRange(period, ref);
    return _repository.getSpendingPoints(startDate: start, endDate: end);
  }
